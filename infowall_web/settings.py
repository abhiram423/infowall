"""
Django settings for infowall_web project.
...
SECRET_KEY = os.environ.get('SECRET_KEY_INFO')
...
ROOT_URLCONF = 'infowall_web.urls'
...
WSGI_APPLICATION = 'infowall_web.wsgi.application'
